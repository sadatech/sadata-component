...
class SosFilters extends QueryFilters
{
    ...
    {
        return $this->builder->whereHas('sos_header.employee', function($q) use ($value){
    ...
    public function byMonth($value = 'all')
    {
        ...
        return $this->builder->whereHas('sos_header', function($q) use ($monthYear){
    ...
    public function byDate($value = 'all')
    {
        ...
        return $this->builder->whereHas('sos_header', function($q) use ($date){
    ...
    public function byAreaScope($value = [])
    {
    	if(empty($value)){
			...
			return $this->builder->whereHas('sos_header.store', function($q) use ($value){
