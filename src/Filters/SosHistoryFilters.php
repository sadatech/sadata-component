...
class SosHistoryFilters extends QueryFilters
{
    ...
    public function employee_id($value = null)
    {
    	...
    	return $this->builder->whereHas('sos_header', function($q) use ($employee_id) {
    		if ($employee_id) {
    ...
    {
    	return $this->builder->whereHas('sos_header', function($q) use ($value) {
